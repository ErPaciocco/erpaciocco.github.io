<template>
    <div class="flex flex-col justify-center items-center">
        ...
        <div class="p-4 rounded-x">
            ...
            <div class="category">
                <span class="text-sm text-primary-light px-2 py-1 rounded-xl" :class="'bg-' + post.color + '-600'">{{ post.categories[0] }}</span>
            </div>
            <h2 class="text-2xl font-bold text-primary-light mb-4">{{ post.title }}</h2>
